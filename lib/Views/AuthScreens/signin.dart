...
import 'package:nsbm_ipt/Controllers/Auth/LoginService.dart';
import 'package:nsbm_ipt/Views/AuthScreens/constants/constants.dart';
import 'package:nsbm_ipt/Views/AuthScreens/signup.dart';
...
import 'package:nsbm_ipt/Views/HomeScreens/HomePage.dart';
        ...
        children: <Widget>[
          Text(
            ...
            style: TextStyle(
              ...
              fontSize: _large ? 40 : (_medium ? 35 : 30),
            ),
          ),
        ],
      ),
  ...
  Widget button() {
    return RaisedButton(
      ...
      onPressed: () {
        ...
        LoginService.login(body, context).then((success) {
          if (success) {
            print("login Success");
